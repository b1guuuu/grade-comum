...
CREATE TABLE IF NOT EXISTS presenca(
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (idProfessor) REFERENCES professor(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS horario (
    ...
    PRIMARY KEY (id),
    FOREIGN KEY (idTurma) REFERENCES turma(id) ON UPDATE CASCADE ON DELETE CASCADE
);
